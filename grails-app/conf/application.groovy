...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'com.ybg.rp.manager.system.SystemUser'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.ybg.rp.manager.system.SystemUserRole'
grails.plugin.springsecurity.auth.loginFormUrl = '/login/form'
grails.plugin.springsecurity.authority.className = 'com.ybg.rp.manager.system.SystemRole'
