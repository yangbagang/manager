...
<div class="box-inner">
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> 标签管理</h2>
        <div class="box-icon">
...
<script>
    ...
    $(document).ready(function(){
        var table=$('#dataTable').DataTable({
            ...
            "columns": [
                ...
                { "title": "名称", "data" : "label", "orderable": true, "searchable": false },
    ...
    function addInfo() {
        var content = "" +
                ...
                '<input type="text" class="form-control" id="label" name="label" placeholder="名称">' +
                '</div>' +
                '<div class="form-group">' +
    ...
    function editInfo(id) {
        var url = '${createLink(controller: "goodsTypeLabel", action: "show")}';
        $.ajax({
            type: "GET",
            url: url,
            data: "id=" + id,
    ...
    function postAjaxRemove(id) {
        var url = '${createLink(controller: "goodsTypeLabel", action: "delete")}/' + id;
        $.ajax({
            type: "DELETE",
            dataType: "json",
            url: url,
    ...
    function postAjaxForm() {
        var url = '${createLink(controller: "goodsTypeLabel", action: "save")}';
        $.ajax({
            type: "POST",
            dataType: "json",
            url: url,
