...
<div class="box-inner">
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> 操作日志</h2>
        <div class="box-icon">
...
<script>
    ...
    $(document).ready(function(){
        var table=$('#dataTable').DataTable({
            ...
            "bAutoWidth": true,
            "ajax": {
                "url":"partnerUserOperationLog/list",
                "dataSrc": "data",
                "data": function ( d ) {
                    //添加额外的参数传给服务器
                    d.name = $("#name").val();
            ...
            "columns": [
                { "title": "时间", "data" : "operationTime", "orderable": true, "searchable": false },
                { "title": "操作人", "data" : "userName", "orderable": true, "searchable": false },
                { "title": "操作类型", "data" : function (data) {
                ...
                { "title": "设备", "data" : "deviceId", "orderable": true, "searchable": false },
                { "title": "轨道", "data" : "orbitalNo", "orderable": false, "searchable": false },
                { "title": "目标", "data" : "targetId", "orderable": true, "searchable": false },
                { "title": "数量", "data" : "targetNum", "orderable": true, "searchable": false },
                { "title": "结果", "data" : "result", "orderable": true, "searchable": false }
            ],
            "language": {
                "zeroRecords": "没有数据",
                "lengthMenu" : "_MENU_",
