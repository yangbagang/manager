...
<div class="box-inner">
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> 大类管理</h2>
        <div class="box-icon">
...
<script>
    ...
    function editInfo(id) {
        var url = '${createLink(controller: "goodsTypeOne", action: "show")}';
        $.ajax({
            type: "GET",
            url: url,
            data: "id=" + id,
    ...
    function postAjaxRemove(id) {
        var url = '${createLink(controller: "goodsTypeOne", action: "delete")}/' + id;
        $.ajax({
            type: "DELETE",
            dataType: "json",
            url: url,
    ...
    function postAjaxForm() {
        var url = '${createLink(controller: "goodsTypeOne", action: "save")}';
        $.ajax({
            type: "POST",
            dataType: "json",
            url: url,
